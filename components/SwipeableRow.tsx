...
const ActionWrapper = ({
  ...
  return (
    ...
    >
      <View
        className={`flex-1 h-full flex-row items-center px-6 ${isLeft ? "justify-start" : "justify-end"
          }`}
      >
        {isLeft ? (
          <>
            ...
            <Reanimated.View style={[textStyle, { marginLeft: 12 }]}>
          ...
          <>
            <Reanimated.View style={[textStyle, { marginRight: 12 }]}>
              <Text className="text-lg font-bold" style={{ color: colors.white }}>
                Message
              </Text>
            </Reanimated.View>
...
export const SwipeableRow = ({
  ...
  return (
    <ReanimatedSwipeable
      ref={swipeRef}
      friction={1.2} // Lowered friction for a more "liquid" feel
      leftThreshold={60} // Easier to open
      rightThreshold={60}
