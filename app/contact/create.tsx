    ...
    return (
        <View className="flex-1 bg-background pt-[StatusBar.currentHeight || 0]">
            <View className="flex-row items-center justify-between px-4 py-3.5 border-b-[0.5px] border-border">
                ...
                <Text className="text-lg font-semibold text-textPrimary">{"New Contact"}</Text>
            ...
            >
                <ScrollView className="flex-1 px-5" keyboardShouldPersistTaps="handled">
                    ...
                    <Animated.View entering={FadeInDown.delay(200).duration(400)} className="mb-6">
                        <Text className="text-sm font-semibold text-textSecondary mb-2.5 uppercase tracking-[0.5px]">{"Name"}</Text>
                        <TextInput
